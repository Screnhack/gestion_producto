...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<th colspan="2">
				<a class="btn  btn-primary" href="{{route('calidad_revista.edit', $object->care_id)}}">Editar</a>
				<a class="btn  btn-primary" href="{{route('calidad_revista.edit', $object->care_id)}}">Eliminar</a>
			</th>
		</tr>
		@endforeach
	</tbody>
