									...
									<table data-sortable class="table">
										...
										<tbody>
											...
											<tr>
												...
												<th colspan="2">
													<a class="btn  btn-warning"  href="{{route('carga_horaria.edit', $object->caho_id)}}"><i class="icon-pencil-3"></i></a>
													<a class="btn  btn-danger"  href="{{route('carga_horaria.edit', $object->caho_id)}}"><i class="icon-trash-3"></i></a>
												</th>
											</tr>
											@endforeach
										</tbody>
