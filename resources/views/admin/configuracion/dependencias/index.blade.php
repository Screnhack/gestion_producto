								...
								<div class="table-responsive">
									<table data-sortable class="table">
										...
										<tr>
											...
											<th colspan="2">
												<a class="btn  btn-warning" href="{{route('dependencias.edit', $object->depe_id)}}"><i class="icon-pencil-3"></i></a>
												<a class="btn  btn-danger" href="{{route('dependencias.edit', $object->depe_id)}}"><i class="icon-trash-3"></i></a>
											</th>
										</tr>
										@endforeach
										</tbody>
