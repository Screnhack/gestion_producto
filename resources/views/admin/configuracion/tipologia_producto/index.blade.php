							...
							<div class="widget-content">			
								<div class="table-responsive">
									<table data-sortable class="table">
										...
										<tbody>
											@foreach($tipologia_producto as $object)
											<tr>
												<th>{{$object->tipr_id}}</th>
												<th>{{$object->tipr_codigo}}</th>
												<th>{{$object->tipr_descripcion}}</th>
												<th colspan="2">
													<a class="btn  btn-warning" href="{{route('tipologia_producto.edit', $object->tipr_id)}}"><i class="icon-pencil-3" ></i></a>
													<a class="btn  btn-danger" href="{{route('tipologia_producto.edit', $object->tipr_id)}}"><i class="icon-trash-3"></i></a>
												</th>
											</tr>
											@endforeach
										</tbody>
