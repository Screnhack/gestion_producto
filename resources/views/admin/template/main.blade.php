            ...
            <div class="navbar-collapse2">
                ...
                <ul class="nav navbar-nav navbar-right top-navbar">
                        ...
                        <ul class="dropdown-menu dropdown-message">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="{{asset('images/users/chat/2.jpg')}}" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="{{asset('images/users/chat/1.jpg')}}" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="{{asset('images/users/chat/3.jpg')}}" class="xs-avatar ava-dropdown" alt="Avatar">
                    ...
                    <li class="dropdown topbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src="{{asset('images/users/user-35.jpg')}}"></span> Jane <strong>Doe</strong> <i class="fa fa-caret-down"></i></a>
					    ...
					    <div id="chat-coll" class="panel-collapse collapse in">
					      <div class="panel-body">
					      	<ul class="list-unstyled" id="chat-list">
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/1.jpg')}}"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/2.jpg')}}"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/3.jpg')}}"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg">Where is my mind</span></a></li>
					      		<li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/4.jpg')}}"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/5.jpg')}}"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="{{asset('images/users/chat/6.jpg')}}"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
					      	</ul>
					      </div>
					    </div>
					  </div>
